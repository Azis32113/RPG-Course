...
{
    public class Fighter : MonoBehaviour, IAction, ISaveable, IModifierProfider
    {
        ...
        void Hit()
        {
            ...
            {
                currentWeapon.value.LaunchProjectile(rightHandTransform, leftHandTransform, target, this.gameObject, damage);
            }
